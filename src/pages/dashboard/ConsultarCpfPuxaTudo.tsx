...
Todos os direitos reservados.`;
  ...
  const spacingVariant = isParentesMode ? 'compact' : 'standard';
  const pageSpacingClass = getDashboardPageClassName(spacingVariant);
  const headerContentSpacingClass = getDashboardHeaderContentGapClassName(spacingVariant);
